    ...
    data() {
      return {
        menuDatas: [
          ...
          {appId: 'SZ50StrategyView', appName: 'SZ50StrategyView', appTitle: '上证50对冲策略', icon: {type: 'KIcon', class: 'ion-ios-shuffle'}},
          {appId: 'StockTestView', appName: 'StockTestView', appTitle: 'A股量化测试', icon: {type: 'KIcon', class: 'ion-levels'}},
