...
export default class BaseComponent extends React.Component {
    ...
    showInfo(message) {
        if(this.refs.infoDialog) {
            this.refs.infoDialog.showInfo(message);
        }
    }

    showError(message) {
        if(this.refs.infoDialog) {
            this.refs.infoDialog.showError(message);
        }
    }
    ...
    _showProgressInfo(message, progressDelay) {
        if(this.refs.infoDialog) {
            this.refs.infoDialog.showProgress(message, progressDelay);
        }
    }

    _hideProgressInfo() {
        if(this.refs.infoDialog) {
            this.refs.infoDialog.hideProgress();
        }
    }
